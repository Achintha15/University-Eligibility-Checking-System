        ...
        <header>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <p><i class="fa fa-envelope-o"></i><span> Email</span><a href="abc@gmail.com">abc@gmail.com</a></p>
                    </div>
    		...
    		<div class="container">
    			<div class="row">
					...
					<h1><span>UECS</span></h1>
    					...
    					<a data-scroll href="login/signup.html" class="btn btn-default wow fadeInUp" data-wow-offset="50" data-wow-delay="0.6s">Sign Up</a>
						<a data-scroll href="login/signin.html" class="btn btn-default wow fadeInUp" data-wow-offset="50" data-wow-delay="0.6s">Sign In</a>
    				</div>
    			</div>
    		</div>
    	</section>
		...
		<section id="about">
			<div class="container">
				<div class="row">
                    ...
                    <div class="sub-element">Note that : we only provide a help to make the right choice</div><hr>
					...
					<div class="col-md-4 col-sm-4 col-xs-12 wow fadeInLeft" data-wow-offset="50" data-wow-delay="0.6s">
						<div class="media">
							<div class="media-heading-wrapper">
								...
								<h3 class="media-heading">Output degree(s) most probable to be selected into.</h3>
							</div>
					...
					<div class="col-md-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-offset="50" data-wow-delay="0.9s">
						<div class="media">
							<div class="media-heading-wrapper">
								...
								<h3 class="media-heading">Filtered degree contents according to each Stream.</h3>
							</div>
					...
					<div class="col-md-4 col-sm-4 col-xs-12 wow fadeInRight" data-wow-offset="50" data-wow-delay="0.6s">
						<div class="media">
							<div class="media-heading-wrapper">
								...
								<h3 class="media-heading">Background Analysis</h3>
							</div>
							<div class="media-body">
    			...
    			<div class="row">
    				...
    				<div class="col-md-6 col-sm-6 col-xs-12 wow fadeInRight" data-wow-offset="50" data-wow-delay="0.6s">
    					<address>
    						...
    						<p><i class="fa fa-map-marker"></i> Kadawala Road,Ratmalana</p>
    					</address>
    					<ul class="social-icon">
